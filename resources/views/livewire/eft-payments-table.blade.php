            ...
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    ...
                    >
                        ...
                        <option value="3" @selected(in_array(3, $transactionType ?? []))>Withdrawal</option>
                        <option value="4" @selected(in_array(4, $transactionType ?? []))>Credit Card</option>
                        <option value="5" @selected(in_array(5, $transactionType ?? []))>Manual Wire</option>
                        <option value="6" @selected(in_array(6, $transactionType ?? []))>Manual Eft</option>
                    </select>
                </div>
                <div class="col-md-2">
...
<script>
function initEftMultiSelects() {
    if (!window.jQuery) {
        return;
    }

    const statusSelect = window.jQuery('#eft-status-filter');
    ...
    const directionSelect = window.jQuery('#eft-direction-filter');
    ...
    const cryptoSelect = window.jQuery('#eft-crypto-filter');
    ...
    const typeSelect = window.jQuery('#eft-type-filter');
    ...
    const brandSelect = window.jQuery('#eft-brand-filter');
