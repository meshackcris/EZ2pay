...
<script>
function initFtdMultiSelects() {
    if (!window.jQuery) {
        return;
    }

    const statusSelect = window.jQuery('#ftd-status-filter');
    ...
    const directionSelect = window.jQuery('#ftd-direction-filter');
    ...
    const cryptoSelect = window.jQuery('#ftd-crypto-filter');
    ...
    const typeSelect = window.jQuery('#ftd-type-filter');
    ...
    const brandSelect = window.jQuery('#ftd-brand-filter');
